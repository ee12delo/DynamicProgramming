 ...
 * Emily DeLorenzo and Austin Crisafulli
 */
public class DynamicProgramming {
    ...
    public static int maxPickUpCoins(int R[], int startIndex) {
        ...
        {
            int val1 = maxPickUpCoins(R, startIndex + 1);
            int val2= maxPickUpCoins(R, startIndex + 2) + R[startIndex];
            if (val1 > val2)
            {
                return val1;
            }
    ...
    public static int maxPickUpCoinsDynProg(int R[], int startIndex, int S[]) {
        ...
        {
            int val1 = maxPickUpCoinsDynProg(R, startIndex + 1, S);
            int val2= maxPickUpCoinsDynProg(R, startIndex + 2, S) + R[startIndex];
            if (val1 > val2)
            {
                S[startIndex] = val1;
                return val1;
